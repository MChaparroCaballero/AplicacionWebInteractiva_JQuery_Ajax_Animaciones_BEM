...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2026 a las 09:58:27
...
(53, 'mchaparro@gmail.com', '2026-01-16 13:30:31', 0.25, 1),
(54, 'mchaparro@gmail.com', '2026-01-19 10:12:50', 1.45, 1),
(55, 'mchaparro@gmail.com', '2026-01-20 10:29:18', 1.20, 1),
(56, 'mchaparro@gmail.com', '2026-01-21 10:31:14', 1.15, 0);
...
(1, 'Manzana', 'Manzana Envy: Crujiente, dulce y jugosa.', 16, 1, 0.50, 'catalogado'),
(2, 'Avocado', 'Aguacates Hass cremosos, perfectos para guacamole.', 1, 1, 1.20, 'catalogado'),
(3, 'Bananas', 'Plátanos de Canarias: Dulces, cultivo tradicional.', 1, 1, 0.25, 'catalogado'),
...
(9, 'Peras', 'Peras Conferencia. Pulpa fina, muy jugosa.', 43, 1, 0.45, 'catalogado'),
...
--
ALTER TABLE `carro`
  MODIFY `CodCarro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT de la tabla `carroproductos`
--
ALTER TABLE `carroproductos`
  MODIFY `CodCarroProd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=153;
